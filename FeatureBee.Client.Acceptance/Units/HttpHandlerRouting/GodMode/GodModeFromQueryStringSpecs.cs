...
namespace FeatureBee.Acceptance.Units.HttpHandlerRouting.GodMode
{
    ...
    public class GodModeFromQueryStringSpecs : WithSubject<GetGodModeFeaturesFromQueryString>
    {
        ...
        Establish context = () =>
        {
            ...
            requestBase.WhenToldTo(_ => _.QueryString).Return((NameValueCollection)null);
        };
        ...
        public class When_getting_god_mode_feature_with_a_featureBee_Header_and_value
        {
            Establish context = () =>
            {
                ...
                header.Add("FeatureBee", "blablablub");

                The<GodModeFeatureStateEvaluator>()
                    .WhenToldTo(_ => _.Parse("blablablub"))
                    .Return(collection);
                requestBase.WhenToldTo(_ => _.QueryString).Return((NameValueCollection)header);
            };
