namespace FeatureBee.Server.Domain.EventHandlers.HubHandlers
{
    ...
    class BroadcastFeatureReleasedForEveryoneEvent : HubBroadcasterFor<FeatureReleasedForEveryoneEvent>
    {
        public override void Broadcast(object eventBody)
        {
            var hub = GlobalHost.ConnectionManager.GetHubContext<BoardHub>();
            hub.Clients.All.featureReleasedForEveryone((eventBody as FeatureReleasedForEveryoneEvent).Name);
        }
    }
}